...
// gets user speicfic id generated by google
...
// inserts title into editor based on selection
...
// gets content of a note based on its mongodb _id
...
// puts content inside text editor for note of given title
...
// gets all notes from mongodb for user
function getNotes() {
  $.ajax({
    url: '/getFiles',
    data: {
...
// deletes single note from mongo db
function deleteNote() {
  $.ajax({
    url: '/delete',
    data: {
...
// converts html input into pdf and saves to google drive
...
// enables footer buttons after successful login
function enableButtons() {
  $(".button-home-notes").removeClass("ui-disabled");
}

// handles authentication for google
handleAuthResult();
